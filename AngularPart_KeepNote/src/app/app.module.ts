...
const appRoutes: Routes = [
  ...
  { path: 'signup', component: SignupComponent },
  {
    ...
    children: [
      {
        path: 'view/noteview', component: NoteViewComponent , runGuardsAndResolvers: 'always',
      },
      {
        path: 'view/listview', component: ListViewComponent, runGuardsAndResolvers: 'always',
      },
      {
